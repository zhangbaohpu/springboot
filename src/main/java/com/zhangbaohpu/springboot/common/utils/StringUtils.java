...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
	...
	　　*/
     ...
     /**
      * 将一个字符串进行处理，将空格、回车、换行符、制表符 用""进行替换
      * @param str
      * @return
      */
     ...
     /**
      * 判断在sourceStr这个字符串中存在多少个targetStr
      * @param sourceStr
      * @param targetStr
      * @return
      */
     public static int charLengthStr(String sourceStr,String targetStr){
    	 int num = -1;
...
//    		num = sourceStr.length()-sourceStr.replace(targetStr,'').length();
    		num = (sourceStr.length() - sourceStr.replace(targetStr,"").length())/(targetStr.length());
    	 }
    	 return num;
     }
}
